...
module.exports = "<ion-app>\n    <ion-menu side=\"end\" menuId=\"loggedout\" contentId=\"main\" type=\"overlay\">\n      <ion-header>\n          <ion-toolbar color=\"tertiary\">\n            <ion-title>Gebruikersmenu</ion-title>\n          </ion-toolbar>\n        </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle>\n            <ion-item routerDirection=\"root\" [routerLink]=\"['/tab-nav/login/']\">\n              <ion-icon name=\"contact\" slot=\"start\"></ion-icon>\n              <ion-label>Inloggen</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n          <ion-menu-toggle>\n            <ion-item routerDirection=\"root\" [routerLink]=\"['/tab-nav/register/']\">\n              <ion-icon name=\"paper-plane\" slot=\"start\"></ion-icon>\n              <ion-label>Registreren</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    \n    <ion-menu side=\"end\" menuId=\"loggedin\" contentId=\"main\">\n      <ion-header>\n          <ion-toolbar color=\"tertiary\">\n            <ion-title>Gebruikersmenu</ion-title>\n          </ion-toolbar>\n        </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle>\n            <ion-item (click)=\"logout()\"  lines=\"none\">\n              <ion-icon name=\"contact\" slot=\"start\"></ion-icon>\n              <ion-label>Uitloggen</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n          <ion-menu-toggle>\n            <ion-item routerDirection=\"root\" [routerLink]=\"['/tab-nav/bookings/']\" lines=\"none\">\n              <ion-icon name=\"paper-plane\" slot=\"start\"></ion-icon>\n              <ion-label>Mijn Reserveringen</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n          <ion-menu-toggle>\n            <ion-item routerDirection=\"root\" [routerLink]=\"['/tab-nav/profile/']\" lines=\"none\">\n              <ion-icon name=\"paper-plane\" slot=\"start\"></ion-icon>\n              <ion-label>Mijn Profiel</ion-label>\n            </ion-item> \n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    \n     <ion-router-outlet id=\"main\"></ion-router-outlet>\n</ion-app>\n"
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storage, plt, http, configService, menu) {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        ...
        return this.http.post(this.url + "api/rest/user/jwt", JSON.stringify({ username: username, password: password }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (jwt) {
            var U = new _models_user__WEBPACK_IMPORTED_MODULE_8__["User"]();
            U.username = username;
            U.password = password;
            U.jwt = jwt;
            U.loggedin = true;
            ...
            _this.menu.enable(false, 'loggedout');
            return U;
        }));
    };
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyAcjZgaNM_LkkbbLXVARDxO0nAcmzxYeUM",
        authDomain: "activitiesapp-43b25.firebaseapp.com",
        databaseURL: "https://activitiesapp-43b25.firebaseio.com",
        projectId: "activitiesapp-43b25",
        storageBucket: "activitiesapp-43b25.appspot.com",
        messagingSenderId: "663771170969",
        appId: "1:663771170969:web:33faf7316cf8b3c74ad008",
        measurementId: "G-RHMHNMYVVN"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\www\activitiesApp\src\main.ts */"./src/main.ts");
