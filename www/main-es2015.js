...
let AuthenticationService = class AuthenticationService {
    constructor(storage, plt, http, configService, menu) {
    ...
    login(username, password) {
        ...
        return this.http.post(`${this.url}api/rest/user/jwt`, JSON.stringify({ username, password }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(jwt => {
            let U = new _models_user__WEBPACK_IMPORTED_MODULE_8__["User"]();
            U.username = username;
            U.password = password;
            U.jwt = jwt;
            U.loggedin = true;
