...
var routes = [
    {
        ...
        children: [
            {
                path: 'activities',
                loadChildren: function () { return __webpack_require__.e(/*! import() | activities-activities-module */ "activities-activities-module").then(__webpack_require__.bind(null, /*! ./../activities/activities.module */ "./src/app/pages/activities/activities.module.ts")).then(function (m) { return m.ActivitiesPageModule; }); }
            },
            {
                path: 'activity-details/:event_id',
                loadChildren: function () { return Promise.all(/*! import() | activity-details-activity-details-module */[__webpack_require__.e("default~activity-booking-activity-booking-module~activity-details-activity-details-module~activity-p~ffa148ef"), __webpack_require__.e("activity-details-activity-details-module")]).then(__webpack_require__.bind(null, /*! ./../activity-details/activity-details.module */ "./src/app/pages/activity-details/activity-details.module.ts")).then(function (m) { return m.ActivityDetailsPageModule; }); }
            },
            {
                path: 'activity-subscribe',
                loadChildren: function () { return Promise.all(/*! import() | activity-subscribe-activity-subscribe-module */[__webpack_require__.e("default~activity-booking-activity-booking-module~activity-details-activity-details-module~activity-p~ffa148ef"), __webpack_require__.e("activity-subscribe-activity-subscribe-module")]).then(__webpack_require__.bind(null, /*! ./../activity-subscribe/activity-subscribe.module */ "./src/app/pages/activity-subscribe/activity-subscribe.module.ts")).then(function (m) { return m.ActivitySubscribePageModule; }); }
            },
            {
                path: 'activity-booking',
                loadChildren: function () { return Promise.all(/*! import() | activity-booking-activity-booking-module */[__webpack_require__.e("default~activity-booking-activity-booking-module~activity-details-activity-details-module~activity-p~ffa148ef"), __webpack_require__.e("activity-booking-activity-booking-module")]).then(__webpack_require__.bind(null, /*! ./../activity-booking/activity-booking.module */ "./src/app/pages/activity-booking/activity-booking.module.ts")).then(function (m) { return m.ActivityBookingPageModule; }); }
            },
            {
                path: 'activity-parts',
                loadChildren: function () { return Promise.all(/*! import() | activity-parts-activity-parts-module */[__webpack_require__.e("default~activity-booking-activity-booking-module~activity-details-activity-details-module~activity-p~ffa148ef"), __webpack_require__.e("activity-parts-activity-parts-module")]).then(__webpack_require__.bind(null, /*! ./../activity-parts/activity-parts.module */ "./src/app/pages/activity-parts/activity-parts.module.ts")).then(function (m) { return m.ActivityPartsPageModule; }); }
            },
            {
                path: 'about',
