...
var ActivitySearchPageRoutingModule = /** @class */ (function () {
    function ActivitySearchPageRoutingModule() {
    }
    ...
    return ActivitySearchPageRoutingModule;
}());
...
var ActivitySearchPageModule = /** @class */ (function () {
    function ActivitySearchPageModule() {
    }
    ...
    return ActivitySearchPageModule;
}());
...
var ActivitySearchPage = /** @class */ (function () {
    /**
     * Constructor of our first page
     * @param activityService The movie Service to get data
     */
    function ActivitySearchPage(activityService, configService, tabnav) {
    ...
    ActivitySearchPage.prototype.ngOnInit = function () {
        this.searchChanged();
    };
    ActivitySearchPage.prototype.searchChanged = function () {
        this.results = this.activityService.searchData(this.searchTerm, this.type);
    };
    ActivitySearchPage.ctorParameters = function () { return [
...
//# sourceMappingURL=activities-activity-search-activity-search-module-es5.js.map